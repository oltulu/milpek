#############################################################################
# Makefile for building: milpek
# Generated by qmake (3.1) (Qt 5.9.1)
# Project:  milpek.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile milpek.pro
#############################################################################
...
CFLAGS        = -pipe -O2 -O2 -pipe -Wall -W -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -O2 -O2 -pipe -std=gnu++11 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtWidgets -isystem /usr/include/qt5/QtGui -isystem /usr/include/qt5/QtCore -I. -isystem /usr/include/libdrm -I. -I/usr/lib/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = milpek1.0.0
DISTDIR = /opt/milpek/.tmp/milpek1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = main.cpp \
		anapencere.cpp moc_anapencere.cpp
OBJECTS       = main.o \
		anapencere.o \
		moc_anapencere.o
DIST          = /usr/lib/qt5/mkspecs/features/spec_pre.prf \
		...
		milpek.pro anapencere.h main.cpp \
		anapencere.cpp
QMAKE_TARGET  = milpek
DESTDIR       = 
TARGET        = milpek
...
Makefile: milpek.pro /usr/lib/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/qt5/mkspecs/common/unix.conf \
		/usr/lib/qt5/mkspecs/common/linux.conf \
		/usr/lib/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/qt5/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents anapencere.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp anapencere.cpp $(DISTDIR)/
	$(COPY_FILE) --parents anapencere.ui $(DISTDIR)/
...
moc_predefs.h: /usr/lib/qt5/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -O2 -pipe -std=gnu++11 -Wall -W -dM -E -o moc_predefs.h /usr/lib/qt5/mkspecs/features/data/dummy.cpp
...
moc_anapencere.cpp: anapencere.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/qt5/mkspecs/linux-g++ -I/opt/milpek -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/5.3.0 -I/usr/include/c++/5.3.0/x86_64-unknown-linux-gnu -I/usr/include/c++/5.3.0/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/5.3.0/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/5.3.0/include-fixed -I/usr/include anapencere.h -o moc_anapencere.cpp
...
ui_anapencere.h: anapencere.ui \
		/usr/lib/qt5/bin/uic
	/usr/lib/qt5/bin/uic anapencere.ui -o ui_anapencere.h
